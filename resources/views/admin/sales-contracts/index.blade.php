                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 sm:px-6">
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        <a href="{{ route('admin.sales-contracts.excel', $salesContract) }}" class="rounded-lg p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-emerald-600" title="Download Excel">
